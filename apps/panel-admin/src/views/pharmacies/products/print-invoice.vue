  ...
  <div class="min-h-screen bg-gray-100 py-8">
    ...
    <div ref="invoiceRef" class="max-w-4xl mx-auto bg-white shadow-lg">
      ...
      <div class="p-6 border-b border-gray-300">
        <div class="flex justify-between items-start">
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              <h2 class="text-2xl font-bold text-gray-900">داروخانه پتومن</h2>
              <p class="text-sm text-gray-600 mt-1">سامانه مدیریت دامپزشکی</p>
        ...
        <div class="p-6 border-l border-gray-300">
          ...
          <div class="space-y-2">
            <div class="flex">
              ...
              <span class="text-sm text-gray-900 font-medium">داروخانه پتومن</span>
            </div>
            <div class="flex">
      ...
      <div class="px-6 py-4 text-center border-t border-gray-300 bg-gray-50">
        <p class="text-xs text-gray-700">با تشکر از خرید شما - داروخانه پتومن</p>
      </div>
    </div>
  </div>
</template>
