...
export const usePharmacyProductStore = defineStore('pharmacyProductStore', () => {
    // ────────────── State ──────────────
    ...
    const fetchGlobalProducts = async () => {
        loading.value = true
        const res = await axios.get('/pharmacy/products/global')
    ...
    const fetchProducts = async () => {
        loading.value = true
        const res = await axios.get('/pharmacy/products')
    ...
    const updateProductStatus = async (productId: string, isActive: boolean) => {
        ...
        try {
            ...
            await axios.patch(`/pharmacy/products/update-status/${productId}`, {
                isActive: isActive
            });
    ...
    const getById = async (id: string) => {
        const res = await axios.get(`/pharmacy/products/${id}`)
    ...
    const createProduct = async (data: any) => {
        ...
        const res = await axios.post('/pharmacy/products', payload)
    ...
    const updateProduct = async (id: string, data: any) => {
        ...
        const res = await axios.patch(`/pharmacy/products/${id}`, payload);
    ...
    const attachProduct = async (data: any) => {
        ...
        const res = await axios.post('/pharmacy/products/attach', payload);
    ...
    const deleteProduct = async (id: string) => {
        const res = await axios.delete(`/pharmacy/products/${id}`)
        const index = products.value.findIndex(p => p.id === id)
        if (index !== -1) {
    ...
    const syncVariants = async (productId: string, variants: any[]) => {
        try {
            ...
            const res = await axios.post(`/pharmacy/products/${productId}/variants/sync`, {
