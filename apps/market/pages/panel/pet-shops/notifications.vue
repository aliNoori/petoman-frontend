...
// Filter Options
const typeOptions = [
  { value: 'all', label: 'همه اعلان‌ها', icon: 'ti ti-bell' },
  { value: 'unread', label: 'خوانده نشده', icon: 'ti ti-bell-ringing' },
  { value: 'orders', label: 'سفارشات', icon: 'ti ti-shopping-cart' },
  { value: 'system', label: 'سیستمی', icon: 'ti ti-settings' },
]
...
const handleAction = (notification) => {
  switch (notification.action) {
    case 'view':
      ...
      navigateTo('/panel/pharmacies/orders')
      break
    case 'deliver':
      // Navigate to orders page
      navigateTo('/panel/pharmacies/orders')
