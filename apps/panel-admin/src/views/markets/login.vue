<template>
  <div class="h-screen flex bg-gray-50 font-vazir overflow-hidden">
    <div class="w-full h-full flex">
      ...
      <div class="w-full lg:w-1/2 bg-white flex items-center justify-center p-6 sm:p-8 lg:p-12">
        <div class="w-full max-w-md">
          ...
          <div class="text-center mb-6">
            <h2 class="text-2xl md:text-3xl font-black text-gray-900 mb-2">ورود به پنل پت مارکت</h2>
            <p class="text-sm text-gray-600">سیستم مدیریت هوشمند فروشگاه حیوانات</p>
          </div>
          ...
          <Transition name="slide-down">
            <div v-if="successMessage" class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-start gap-2">
              <i class="ti ti-circle-check text-blue-500 text-lg flex-shrink-0"></i>
              <p class="text-sm font-semibold text-blue-900">{{ successMessage }}</p>
            </div>
          </Transition>
          ...
          <div v-if="!showOtpInput">
            ...
            <div class="relative">
              <input
                ...
                class="w-full px-4 py-3 bg-gray-50 rounded-lg transition-all text-right text-sm outline-none border-none focus:ring-1 focus:ring-blue-500"
          ...
          <div v-if="!showOtpInput">
            ...
            <div class="relative">
              <input
                ...
                maxlength="11"
                @input="formatMobile"
                class="w-full px-4 py-3 bg-gray-50 rounded-lg transition-all font-english text-left text-sm outline-none border-none focus:ring-1 focus:ring-blue-500"
          ...
          <div v-if="showOtpInput">
            ...
            <div class="flex justify-center gap-2 mt-4" dir="ltr">
              <input
                ...
                class="w-14 h-14 text-center text-2xl font-bold bg-gray-50 rounded-lg transition-all outline-none border-none focus:ring-1 focus:ring-blue-400"
              />
            </div>
            ...
            <p class="mt-3 text-xs text-gray-600 text-center">
              ...
              <button 
                ...
                @click="resendOtp"
                :disabled="otpTimer > 0"
                class="text-xs text-blue-500 hover:text-blue-600 font-semibold disabled:text-gray-400 disabled:cursor-not-allowed"
              >
          ...
          <div v-if="!showOtpInput">
            ...
            <div class="relative">
              <input
                ...
                class="w-full px-4 py-3 pl-12 bg-gray-50 rounded-lg transition-all text-sm outline-none border-none focus:ring-1 focus:ring-blue-500"
          ...
          <div v-if="!showOtpInput" class="flex items-center justify-between text-sm">
            ...
            <button type="button" class="text-blue-500 hover:text-blue-600 font-medium transition-colors">
              فراموشی رمز عبور؟
            </button>
          </div>
          ...
          <button
            type="submit"
            :disabled="isLoading"
            class="w-full py-2.5 bg-gradient-to-l from-blue-500 to-blue-400 text-white rounded-lg font-bold hover:from-blue-600 hover:to-blue-500 transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg shadow-blue-500/30"
          >
        ...
        <div class="mt-5 pt-5 border-t border-gray-200">
          ...
          <div class="flex items-center justify-center gap-3 flex-wrap text-xs">
            <a href="tel:02188888888" class="flex items-center gap-1.5 text-blue-500 hover:text-blue-600 transition-colors">
              <i class="ti ti-phone"></i>
              <span class="font-english">021-88888888</span>
            </a>
            <span class="text-gray-300">|</span>
            <a href="mailto:support@petoman.com" class="flex items-center gap-1.5 text-blue-500 hover:text-blue-600 transition-colors">
      ...
      <div class="hidden lg:flex w-1/2 bg-gradient-to-r from-blue-400 to-blue-500 relative overflow-hidden">
        <!-- Background Pattern -->
...
const features = ref([
  {
    ...
    description: 'کنترل لحظه‌ای موجودی، قیمت و هشدار کمبود محصولات'
  },
  {
    icon: 'ti ti-file-text',
    title: 'سفارش‌های آنلاین',
    description: 'دریافت و پردازش سریع سفارشات آنلاین از مشتریان'
  },
  {
  ...
  if (!showOtpInput.value) {
    ...
    try {
      ...
      if (typeof window !== 'undefined') {
        localStorage.setItem('pet_shop_user', JSON.stringify(petShopUser))
        
        successMessage.value = 'ورود موفقیت‌آمیز! در حال انتقال...'
        
        setTimeout(() => {
          window.location.href = '/panel/pet-shops'
        }, 1000)
      }
    } catch (error) {
