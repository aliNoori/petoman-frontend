  ...
  <div class="space-y-6">
    ...
    <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-8 text-white">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold mb-2">سوالات متداول کلینیک‌ها</h1>
          <p class="text-emerald-100">پاسخ به سوالات رایج درباره پنل کلینیک‌های پتومن</p>
        </div>
    ...
    <div class="bg-white rounded-xl p-6">
      <div class="relative">
        ...
        <input
          ...
          class="w-full pr-12 pl-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
        >
      </div>
    </div>
    ...
    <div class="grid md:grid-cols-4 gap-4">
      ...
      >
        ...
        <p class="text-xs mt-1" :class="selectedCategory === cat.id ? 'text-emerald-100' : 'text-gray-500'">
          {{ cat.count }} سوال
        </p>
      </button>
    </div>
        ...
        >
          <div class="flex items-start gap-4 flex-1">
            <div
              ...
              :class="expandedFAQs.includes(index) ? 'bg-emerald-100' : 'bg-gray-100'"
            >
              <i
                :class="expandedFAQs.includes(index) ? 'ti ti-question-mark text-emerald-600' : 'ti ti-question-mark text-gray-600'"
                class="text-xl"
              ></i>
            </div>
            <div class="flex-1">
        ...
        <Transition name="slide-down">
          <div v-if="expandedFAQs.includes(index)" class="px-6 pb-6">
            <div class="pr-14 text-gray-600 leading-relaxed">
              <p>{{ faq.answer }}</p>
              <div v-if="faq.note" class="mt-4 p-4 bg-emerald-50 rounded-lg border-r-4 border-emerald-500">
    ...
    <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-8 text-center">
      <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center mx-auto mb-4">
      ...
      <router-link
        to="/panel/clinics/support"
        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-lg font-medium hover:from-emerald-600 hover:to-emerald-700 transition-all"
      >
