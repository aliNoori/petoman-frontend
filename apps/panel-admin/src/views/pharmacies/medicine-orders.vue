...
const statusFilterOptions = [
  ...
  { value: 'pending', label: 'در انتظار', icon: 'ti ti-clock', iconColor: 'text-orange-500' },
  { value: 'processing', label: 'در حال پردازش', icon: 'ti ti-loader', iconColor: 'text-blue-500' },
  { value: 'waiting-customer', label: 'در انتظار تایید مشتری', icon: 'ti ti-user-check', iconColor: 'text-purple-500' },
  { value: 'ready', label: 'آماده تحویل', icon: 'ti ti-package', iconColor: 'text-teal-500' },
  { value: 'delivered', label: 'تحویل شده', icon: 'ti ti-circle-check', iconColor: 'text-green-500' },
  { value: 'rejected', label: 'رد شده', icon: 'ti ti-x', iconColor: 'text-red-500' }
]

const typeFilterOptions = [
  { value: '', label: 'همه', icon: 'ti ti-list' },
  { value: 'prescription', label: 'با نسخه', icon: 'ti ti-file-description', iconColor: 'text-purple-500' },
  { value: 'no-prescription', label: 'بدون نسخه', icon: 'ti ti-file-off', iconColor: 'text-gray-500' }
]

// استفاده از store برای سفارشات
const orders = computed(() => ordersStore.medicineOrders)
