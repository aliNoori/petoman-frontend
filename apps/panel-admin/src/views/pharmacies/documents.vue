  ...
  <div class="min-h-screen bg-gray-50 p-6">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600">آپلود و مدیریت مدارک رسمی داروخانه</p>
      </div>
...
const documents = ref([
  {
    id: 1,
    name: 'پروانه فعالیت',
    description: 'پروانه رسمی فعالیت داروخانه از وزارت بهداشت',
    icon: 'ti ti-license',
  ...
  },
  {
    id: 2,
    name: 'گواهی صلاحیت',
    description: 'گواهی صلاحیت حرفه‌ای داروساز مسئول',
  ...
  },
  {
    id: 3,
    name: 'کارت ملی',
    description: 'تصویر کارت ملی مدیر مسئول داروخانه',
    icon: 'ti ti-id-badge',
    accept: '.jpg,.jpeg,.png',
    acceptLabel: 'JPG, PNG',
    maxSize: 2,
  ...
  },
  {
    id: 4,
    name: 'مدرک تحصیلی',
    description: 'مدرک تحصیلی داروسازی',
    icon: 'ti ti-school',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptLabel: 'PDF, JPG, PNG',
    maxSize: 5,
  ...
  },
  {
    ...
    description: 'مدرک مالکیت یا اجاره محل داروخانه',
    icon: 'ti ti-building',
    accept: '.pdf,.jpg,.jpeg,.png',
    acceptLabel: 'PDF, JPG, PNG',
    maxSize: 5,
