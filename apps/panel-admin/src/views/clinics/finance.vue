    ...
    >
      <div
        ...
        :class="[
          ...
          toast.type === 'success' ? 'bg-sky-400 text-white' :
        ...
        <div class="flex gap-2 p-2 overflow-x-auto">
          <button
            ...
            :class="[
              ...
              activeTab === tab.id ? 'bg-sky-50 text-sky-400' : 'text-gray-600 hover:bg-gray-50'
            ]"
          >
            <i :class="tab.icon"></i>
            {{ tab.label }}
            <span v-if="tab.badge" class="px-2 py-0.5 rounded-full bg-sky-400 text-white text-xs">{{ tab.badge }}</span>
          </button>
        </div>
      </div>
        ...
        <div class="flex flex-col sm:flex-row gap-3 mb-6">
          <div class="flex-1 relative">
            ...
            <input
              ...
              class="w-full pr-10 pl-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
            />
          </div>
          <AppSelect
            v-model="filterType"
          ...
          >
            <div class="flex items-start justify-between mb-3">
              ...
              <span :class="[
                ...
                withdrawal.status === 'completed' ? 'bg-sky-100 text-sky-500' :
          ...
          <div class="border-t pt-4">
            ...
            <div class="flex gap-2 mb-4">
              <button
                ...
                :class="[
                  ...
                  newCard.inputType === 'card' ? 'bg-sky-400 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                ]"
              >
              ...
              <button
                ...
                :class="[
                  'flex-1 px-3 py-2 rounded-lg text-sm font-medium transition-colors',
                  newCard.inputType === 'iban' ? 'bg-sky-400 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                ]"
              >
            ...
            <div v-if="newCard.inputType === 'card'">
              ...
              <input
                ...
                class="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 font-english disabled:bg-gray-100"
              />
            ...
            <div v-if="newCard.inputType === 'iban'">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  maxlength="26"
                  :disabled="newCard.verifying"
                  class="w-full pr-9 sm:pr-10 pl-3 sm:pl-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 font-english disabled:bg-gray-100"
                />
              </div>
            ...
            <div class="flex gap-2 pt-2">
              <button
                ...
                class="flex-1 px-4 py-2.5 bg-sky-400 text-white rounded-lg font-medium hover:bg-sky-500 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm"
              >
        ...
        <div class="bg-white rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <div class="p-6 space-y-4">
            ...
            <div class="bg-sky-50 border border-sky-200 rounded-xl p-4">
              ...
              <p class="text-2xl font-bold text-sky-400 font-english">{{ formatNumber(withdrawable) }} تومان</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="0"
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 font-english text-lg"
              />
            ...
            <div>
              ...
              <div v-else class="space-y-2">
                <label
                  ...
                  :class="withdrawForm.selectedCardId === card.id ? 'border-sky-500 bg-sky-50' : 'border-gray-200'"
                >
                  <input
                    type="radio"
                    :value="card.id"
                  ...
                  <div class="flex-1">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span v-if="card.isDefault" class="text-xs bg-sky-100 text-sky-500 px-2 py-0.5 rounded-full">پیش‌فرض</span>
                    </div>
          ...
          <div class="sticky bottom-0 bg-white border-t border-gray-200 px-6 py-4 flex gap-3">
            ...
            <button
              ...
              class="flex-1 px-4 py-3 bg-sky-400 text-white rounded-lg font-medium hover:bg-sky-500 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
              ثبت درخواست
            </button>
          </div>
...
const { balance, transactions,platformFeeTransactions,wallet } = storeToRefs(walletStore)
...
const bankInfo = computed(() => ({
  accountName: tenantInfoSetting.value.name||tenantInfoSetting.value.ownerName||tenant.value.name ||tenant.value.ownerName || '',
...
const platformFee = computed(() => {
  // اگر داده‌ای وجود ندارد، مجموع صفر است
  ...
  platformFeeTransactions.value.forEach(t => {
    // بررسی نوع تراکنش (هم فرمت انگلیسی و هم فارسی را پوشش می‌دهد)
    if (t.type === 'FEE_INCOME' || t.type === 'fee_income' || t.type === 'کارمزد') {
      // تبدیل مقدار به عدد و جمع زدن
...
const feePercentage = ref(5) // TODO: دریافت از تنظیمات
