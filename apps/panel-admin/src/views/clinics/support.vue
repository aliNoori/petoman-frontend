  ...
  <div class="space-y-6">
    ...
    <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-8 text-white">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold mb-2">پشتیبانی کلینیک‌های پتومن</h1>
          <p class="text-emerald-100">ارسال تیکت و دریافت پشتیبانی از تیم پتومن</p>
        </div>
    ...
    <div class="grid md:grid-cols-3 gap-4">
      ...
      <div class="bg-white rounded-xl p-6">
        ...
        <p class="text-emerald-600 font-bold">clinic-support@petoman.com</p>
      </div>
    ...
    <div class="bg-white rounded-xl p-6">
      <div class="flex items-center gap-3 mb-6">
        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-100 to-emerald-200 flex items-center justify-center">
          <i class="ti ti-ticket text-emerald-600 text-2xl"></i>
        </div>
        <div>
      ...
      <form @submit.prevent="submitTicket" class="space-y-6">
        ...
        <div class="relative">
          ...
          <button
            ...
            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all text-right flex items-center justify-between"
          ...
          <Transition name="slide-down">
            ...
            >
              <li
                ...
                :class="ticketForm.department === dept.value ? 'bg-emerald-50 text-emerald-600 font-medium' : 'text-gray-700'"
              >
          ...
          <div class="grid grid-cols-3 gap-3">
            ...
            >
              <input
                ...
                required
              >
              <div class="p-3 border-2 border-gray-200 rounded-lg text-center transition-all peer-checked:border-emerald-500 peer-checked:bg-emerald-50">
        ...
        <div class="flex items-center gap-4">
          <button
            ...
            class="flex-1 px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-lg font-medium hover:from-emerald-600 hover:to-emerald-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
