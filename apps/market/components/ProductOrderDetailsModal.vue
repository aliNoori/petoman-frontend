<template>
  <Transition name="modal">
    <div v-if="show" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" @click.self="$emit('close')">
      <!-- Modal panel -->
      <div class="relative w-full max-w-4xl max-h-[90vh] flex flex-col text-right transform bg-white shadow-2xl rounded-2xl overflow-hidden z-10">
          <!-- Header - Sticky -->
          <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-purple-100 flex-shrink-0">
          ...
          <div class="flex items-center justify-between gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50 flex-shrink-0">
